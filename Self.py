...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Owner : line://ti/p/~gjxvipro",
    "lang":"JP",
    "comment":"Owner : line://ti/p/~gjxvipro",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
                ...
                if msg.from_ in admin:
                  bctxt = msg.text.replace("Spam ", "ajor")
...
#-----------------------------------------------
				...
				kk.sendText(msg.to,"Wa'alaikumsalam")
				kc.sendText(msg.to,"Bye")
#-----------------------------------------------
            elif msg.text in ["Responsename","respon"]:
				if msg.from_ in admin:
					ki.sendText(msg.to,"==VIPRO==")
#-----------------------------------------------
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By ==Vipro==
						print "DiLike"
					except:
							pass
				else:
